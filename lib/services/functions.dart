...
class Functions extends Service {
    ...
    Future<Response> deleteTag({required String functionId, required String tagId}) {
     ...
     /// Get Function Usage
    Future<Response> getUsage({required String functionId, String range = '30d'}) {
        final String path = '/functions/{functionId}/usage'.replaceAll(RegExp('{functionId}'), functionId);
